    ...
    <main className="min-h-screen flex items-center justify-center bg-white">
      <div className="max-w-3xl text-center p-8">
        ...
        <div className="flex gap-4 justify-center">
          <a href="/auth" className="px-5 py-3 rounded-xl bg-[#00A9E0] text-white shadow">Login / Sign up</a>
          <a href="/auth/roles" className="px-5 py-3 rounded-xl border border-[#E0E0E0] text-[#0078D4]">Choose Role</a>
        </div>
      </div>
    </main>
  );
